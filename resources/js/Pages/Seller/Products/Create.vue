    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-4">
                ...
                <h2 class="text-2xl font-black text-gray-900 dark:text-gray-100">Tambah Produk Baru</h2>
            </div>
        </template>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <TextInput id="material" type="text" class="mt-1 block w-full rounded-2xl" v-model="form.material" placeholder="Contoh: PET, HDPE" />
                                </div>
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        <InputLabel for="volume" value="Volume" />
                                        <TextInput id="volume" type="text" class="mt-1 block w-full rounded-2xl" v-model="form.volume" placeholder="Contoh: 500ml" />
                                    </div>
                                    <div>
                                        <InputLabel for="color" value="Warna" />
                                        <TextInput id="color" type="text" class="mt-1 block w-full rounded-2xl" v-model="form.color" placeholder="Contoh: Bening" />
                                    </div>
                                </div>
                                <div>
