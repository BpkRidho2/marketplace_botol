...
<template>
    <AuthLayout>
        ...
        <div class="mb-8 text-center">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Selamat Datang</h2>
            <p class="text-sm text-gray-500 mt-2">Silakan masuk ke akun Anda untuk berbelanja</p>
        </div>
        ...
        <form @submit.prevent="submit" class="space-y-6">
            ...
            <div class="text-center mt-6">
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    Belum punya akun? 
                    <Link :href="route('register')" class="text-primary-600 hover:text-primary-700 font-bold">
                        Daftar Gratis
                    </Link>
                </p>
            </div>
