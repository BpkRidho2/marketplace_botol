        ...
        <div class="space-y-6 max-w-4xl mx-auto">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-400 mt-1">Lengkapi informasi produk Anda</p>
                </div>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border-t-4 border-yellow-600">
                    ...
                    <div v-else class="w-full max-w-md h-64 bg-gray-100 dark:bg-gray-700 rounded-lg flex items-center justify-center">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border-t-4 border-pink-600">
                    ...
                    />
                    <div v-if="previewGallery.length > 0" class="mt-4 grid grid-cols-2 md:grid-cols-4 gap-3">
