            ...
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-400 mt-1">
                        Kelola pesanan terbaru dari pelanggan
                    </p>
                </div>
            </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left">
                        ...
                        >
                            <tr>
                                <th
                                    class="px-6 py-3 text-sm font-bold text-gray-700 dark:text-gray-300"
                                >
                                    No
                                </th>
                                <th
                        ...
                        >
                            ...
                            >
                                ...
                                <td
                                    class="px-6 py-4 text-sm font-semibold text-primary-600 dark:text-primary-400"
                                >
                                    #{{ order.order_number }}
                                </td>
                                <td
